...
| **Image** <br/> Embeds an JPG or PNG uploaded, from the web, or from a synapse file. **Note:** Images with the word 'ad' in it will be blocked if you are using an adblocker. ||
