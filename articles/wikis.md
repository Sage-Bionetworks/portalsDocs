...
| **Image** <br/> Embeds an JPG or PNG. The image can be uploaded, from the web, or from a Synapse file. **Note:** Images with the word 'ad' in it will be blocked if you are using an adblocker. ||
