...
f <- synStore(f)
```
Please see the [REST docs](http://rest-docs.synapse.org/org/sagebionetworks/repo/model/project/ExternalS3StorageLocationSetting.html) for more information on setting external storage location settings using our REST API.
...
Please see the [REST docs](http://rest-docs.synapse.org/org/sagebionetworks/repo/model/project/ExternalGoogleCloudStorageLocationSetting.html) for more information on setting external storage location settings using our REST API.
