...
The full list of possible login parameters for the Python client can be found in the [Python Docs](https://sage-bionetworks.github.io/synapsePythonClient/build/html/Client.html#login) and for the R client in the [R Docs](http://sage-bionetworks.github.io/synapser/articles/synapser.html#connecting-to-synapse). 
