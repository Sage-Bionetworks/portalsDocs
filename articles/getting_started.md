...
Content created in Synapse are assigned unique accession ids which are used to uniquely reference your content. For example, your newly created `Project` will have a Synapse Id with the format syn1234.
