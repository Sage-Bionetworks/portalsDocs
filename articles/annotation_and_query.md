...
***NOTE:*** *you will only be able to query the files you have permission to access.*
...
Enter your query in the box and click teh `Insert` button. Once you `Save` the wiki page, the results will be displayed as a table.
