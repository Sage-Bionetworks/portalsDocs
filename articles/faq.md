...
Yes, Synapse is built on top of a RESTful service that is automatically [documented](http://docs.synapse.org/rest). In addition, we have purpose built APIs for [Python](https://sage-bionetworks.github.io/synapsePythonClient/), [R](https://sage-bionetworks.github.io/synapser/), Java and a [command line](https://sage-bionetworks.github.io/synapsePythonClient/build/html/CommandLineClient.html) interface.
