...
* **Supporting genome**-scale analysis - Analyzing whole genome datasets is currently limited to those with access to large computational resources and significant IT support. Synapse facilitates a computational style where code and users can move to the data, wherever it is stored.
