...
1. Physically sign (in ink), initial, and submit the Synapse [Oath]({% link assets/other/oath.md %})
...
* A letter from a signing official on letterhead attesting to your identity. _Please note that you can not serve as your own signing official_ ([template here]({% link assets/other/signing_official_template.md %})) OR
* A notarized letter attesting to your identity ([template here]({% link assets/other/notarized_letter_template.md %})) OR
