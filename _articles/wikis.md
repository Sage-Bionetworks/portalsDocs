...
| **Join Team Button** <br/> Provide a button for people to join Synapse [Teams]({% link _articles/teams.md %}) | <img id="image" src="../assets/images/wiki_jointeambutton.png"> |
...
[Discussion]({% link _articles/discussion.md %})
